...
@Component({
  selector: 'synkwise-resident-careplan-bowel',
  templateUrl: 'bowel.component.html',
  styleUrls: ['bowel.component.css']
})
export class CareplanBowelComponent implements OnInit, OnChanges {
  @Input() initialDetails: any;
  private itemBowelDetails: any;

  ngOnInit() {
    this.itemBowelDetails = [{label: "Daytime needs", id1:"eliminationInput1", id2:"eliminationInput2"},
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['initialDetails'] && this.initialDetails) {
      this.itemBowelDetails = this.initialDetails;
    }
  }
